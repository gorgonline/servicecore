...
const modules = [
  ...
  { name: "Service Topologies Explorer", icon: Waypoints, desc: "Servis haritasını canlı keşfedin, etkiyi anlık görün.", href: "/servis-topoloji-kesif" },
  ...
  { name: "Vardiya Yönetimi", icon: CalendarClock, desc: "Vardiya, nöbet ve kapasiteyi tek panelde planlayın.", href: "/vardiya-yonetimi" },
  ...
  { name: "Federation Engine", icon: Combine, desc: "Çoklu tenant ve organizasyonu tek orkestratörle bağlayın.", href: "/federasyon-motoru" },
...
const plansSubmenu = [
  ...
  { name: "ITAM Lisans Seçenekleri", icon: Boxes, desc: "IT Asset Management — tek paket; varlık keşfi ve CMDB dahil.", href: "/planlar-itam" },
  { name: "EAM Lisans Seçenekleri", icon: Package, desc: "Enterprise Asset Management — tek paket; bakım ve saha operasyonları dahil.", href: "/planlar-eam" },
