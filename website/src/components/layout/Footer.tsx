...
const footerData = {
  ...
  columns: [
    ...
    },
    {
      title: "AICORE",
      links: [
        { text: "Replycore SolveAI", href: "/aicore/replycore-solve" },
        { text: "Chatcore-SelfAI", href: "/aicore/chatcore-self" },
        { text: "Classificore ManageAI", href: "/aicore/classificore-manage" },
        { text: "PrioritycoreAI", href: "/aicore/prioritycore" },
        { text: "RootCoreAI", href: "/aicore/rootcore" },
        { text: "PredicticoreAI", href: "/aicore/predicticore" },
        { text: "ScoreAI", href: "/aicore/score" },
        { text: "KnowCoreAI", href: "/aicore/knowcore" },
        { text: "FlowCoreAI", href: "/aicore/flowcore" },
        { text: "DiscoreAI", href: "/aicore/discore" },
        { text: "TranslateAI", href: "/aicore/translate" },
        { text: "MergeAI", href: "/aicore/merge" },
        { text: "ProjectplanpredictAI", href: "/aicore/projectplanpredict" },
        { text: "VisicoreAI", href: "/aicore/visicore" },
        { text: "SentimentAI", href: "/aicore/sentiment" },
        { text: "KnowcoreAI (Şablon)", href: "/aicore/knowcore-template" },
        { text: "ToneAI", href: "/aicore/tone" },
        { text: "ImpacticoreAI", href: "/aicore/impacticore" },
        { text: "ShiftAI", href: "/aicore/shift" },
        { text: "AuditAI", href: "/aicore/audit" },
        { text: "AssetLifecycleAI", href: "/aicore/asset-lifecycle" },
      ],
    },
    {
      title: "ÇÖZÜMLER",
