  ...
  columns: [
    {
      ...
      links: [
        ...
        { text: "Service Topologies Explorer", href: "/servis-topoloji-kesif" },
    ...
    },
    {
      ...
      links: [
        ...
        { text: "Vardiya Yönetimi", href: "/vardiya-yonetimi" },
        ...
        { text: "Federation Engine", href: "/federasyon-motoru" },
        ...
        { text: "Integration System", href: "/entegrasyon-sistemi" },
