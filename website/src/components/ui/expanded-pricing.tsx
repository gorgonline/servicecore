...
const proOnlyFeatures: PricingFeature[] = [
  ...
  { title: "Low Code Form Design", description: "ServiceCore, yenilikçi Low-Code Form Oluşturma özelliği ile işletmeniz ihtiyaçlarına uygun özel formlar oluşturmanızı kolaylaştırır. Teknik bilgiye ihtiyaç duymadan, sürükle-bırak yöntemiyle hızlı ve etkili çözümler üretebilirsiniz." },
  ...
  { title: "Validasyonlar ve Süreç Doğrulama", description: "ServiceCore, iş süreçlerinizin düzenli ve eksiksiz bir şekilde yürütülmesini sağlamak için güçlü Zorunlu Alan Validasyonu özellikleri sunar. Bu özellik sayesinde, farklı modüllerde (varlık, değişiklik, olay, problem, iyileştirme, görev, işbirlikleri, proje gibi) belirli alanların doldurulmasını zorunlu hale getirebilirsiniz." },
  { title: "Kapsamlı Süreç Şablonları", description: "ServiceCore, iş süreçlerinizi daha şeffaf ve verimli hale getirmek için kapsamlı bir Worklog Yönetimi sunar. Bu özellik, kayıtlar içerisine eklenen iş günlüklerini detaylı bir şekilde takip etmenizi ve bu verilerden yola çıkarak efor hesaplamaları yapmanızı sağlar." },
  { title: "Zamanlanmış ve Dinamik Raporlar", description: "ServiceCore, kullanıcıların raporları belirli zaman dilimlerinde otomatik olarak almasını sağlayan Zamanlanmış Rapor özelliği sunar. Bu özellik, raporlama sürecini daha verimli hale getirir ve verilerin düzenli aralıklarla toplanmasını sağlar." },
  ...
  { title: "Multi Company / Holding Yapısı (ESM)", description: "ServiceCore ESM (Enterprise Service Management), şirket içindeki tüm hizmet süreçlerini yönetmek için entegre bir yaklaşım sunar. Bu, sadece IT (Bilgi Teknolojileri) departmanı ile sınırlı kalmaz, aynı zamanda diğer departmanlar ve iş birimlerinin hizmet yönetimi uygulamalarını da kapsar. ServiceCore'un ESM yaklaşımı, organizasyonun genel verimliliğini artırmayı ve müşteri memnuniyetini yükseltmeyi hedefler." }
];
...
const addonCategories: AddonCategory[] = [
  {
    ...
    items: [
      { name: "Proje Yönetimi Modülü", desc: "ITIL4 ile birlikte proje yönetimi süreci ITSM’in doğal bir parçası ve zorunlu bir pratiği haline gelmiştir. Projelerin doğuşu her zaman iyileştirme, değişiklik, istek gibi süreçler tarafından tetiklenmektedir ve proje çıktıları çoğunlukla bu süreçlere geri besleme yapmayı gerektirmektedir." },
  ...
  },
  {
    ...
    items: [
      { name: "VMware Varlık Keşif Eklentisi", desc: "ServiceCore VMware Varlık Keşif Eklentisi, VMware ortamındaki sanal makineleri ve altyapıyı otomatik olarak keşfetmenize olanak tanır. Bu özellik, IT varlık yönetimini daha verimli hale getirir ve sanal altyapınızdaki varlıkları doğru bir şekilde izleyerek, yapılandırma yönetimini güçlendirir." },
      { name: "MS Teams Eklentisi", desc: "ServiceCore MS Teams Eklentisi, Microsoft Teams ile entegre olarak, hizmet yönetimi ve işbirliği süreçlerini daha verimli hale getirir." },
      { name: "Task Calendar Sync Eklentisi", desc: "ServiceCore kullanıcıların Microsoft Exchange takvimlerini ve e-posta sistemlerini ServiceCore platformu ile entegre ederek verimli bir şekilde hizmet yönetimi yapmalarını sağlar." },
      { name: "Failover / Cluster Sistem Add-on", desc: "ServiceCore Failover / Cluster Sistem Add-on, yüksek erişilebilirlik ve kesintisiz hizmet sağlamak amacıyla, ServiceCore platformunun yedekli bir yapıda çalışmasına olanak tanır. Bu özellik, kritik iş süreçlerinin ve hizmetlerin herhangi bir kesinti durumunda devamlılık göstermesini sağlar. Failover ve Cluster sistemleri, platformun daha dayanıklı, güvenilir ve kesintisiz çalışmasını garanti eder." },
      { name: "Disaster Center Add-on", desc: "ServiceCore Disaster Center Add-on, şirketlerin olası felaket durumlarına karşı hazırlıklı olmalarını sağlamak amacıyla, hizmet yönetimi süreçlerini güvence altına alır." },
      { name: "Sandbox / Test Sistem Add-on", desc: "ServiceCore Sandbox / Test Sistem Add-on, kullanıcıların ServiceCore platformu üzerinde gerçekleştirecekleri değişiklikler ve yenilikleri gerçek ortamda uygulamadan önce güvenli bir şekilde test etmelerini sağlar." }
    ]
  },
  {
...
export function ExpandedPricingSection() {
  return (
