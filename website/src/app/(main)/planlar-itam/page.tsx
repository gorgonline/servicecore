...
import pricingData from "@/data/pricing-itam.json";
import { HelpCircle } from "lucide-react";
import PrivacyContact from "@/components/ui/privacy-contact";

export const metadata = {
  title: pricingData.metaTitle,
  description: pricingData.metaDescription,
  alternates: { canonical: "/planlar-itam" },
};

export default function PlanlarItamPage() {
  return (
