...
export default function FeaturesPage() {
  return (
    <main className="relative min-h-screen bg-(--color-surface-base) pb-32 pt-24 overflow-hidden">
      {/* Background Decor */}
      <div className="absolute top-0 inset-x-0 h-96 bg-linear-to-b from-(--color-brand-primary)/10 to-transparent pointer-events-none" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20 relative">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white tracking-tight mb-8">
            İşletmeniz İçin <span className="text-transparent bg-clip-text bg-linear-to-r from-(--color-brand-primary) to-(--color-brand-accent)">En İyi</span> Çözümler
          </h1>
