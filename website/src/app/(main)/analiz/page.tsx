...
import { AnalizForm } from "@/components/ui/analiz-form";

export const metadata: Metadata = {
  title: "Gereksinim Analiz Formu | ServiceCore",
  description: analizData.page.description,
  robots: {
    index: false,
    follow: false,
    nocache: true,
...
export default function AnalizPage() {
  const { page, intro, sections } = analizData;
  ...
  return (
    <main className="relative min-h-screen bg-(--color-surface-base) pb-32 pt-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
        ...
        {/* Grid: Sol — sticky bilgi & section index, Sağ — form */}
