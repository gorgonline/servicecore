            ...
            <div className="w-full lg:w-1/2">
              <div className="relative rounded-[2.5rem] p-6 lg:p-8 border border-white/10 bg-linear-to-br from-blue-500/5 to-cyan-500/5 backdrop-blur-xl group overflow-hidden">
                ...
                <div className="relative w-full h-112.5 rounded-2xl overflow-hidden bg-white border border-white/5 shadow-2xl">
                  <Image
                    src="/images/olay-modulu/Index.png"
                    alt="Merkezi olay yönetimi panosu — olay listesi ve çoklu kaynak entegrasyonu"
                    width={1427}
                    height={512}
          ...
          >
            <div className="w-full lg:w-1/2">
              <div className="relative rounded-[2.5rem] p-6 lg:p-8 border border-white/10 bg-linear-to-br from-emerald-500/5 to-cyan-500/5 backdrop-blur-xl group overflow-hidden">
                ...
                <div className="relative w-full h-112.5 rounded-2xl overflow-hidden bg-white border border-white/5 shadow-2xl">
                  <Image
                    src="/images/olay-modulu/sla.png"
                    alt="Dinamik SLA takibi ve anlık uyarı paneli"
                    width={1260}
                    height={836}
                    className="absolute inset-0 w-full h-full object-cover object-top-left group-hover:scale-[1.01] transition-transform duration-500"
                  />
          ...
          >
            <div className="w-full lg:w-1/2">
              <div className="relative rounded-[2.5rem] p-6 lg:p-8 border border-white/10 bg-linear-to-br from-purple-500/5 to-indigo-500/5 backdrop-blur-xl group overflow-hidden">
                ...
                <div className="relative w-full h-112.5 rounded-2xl overflow-hidden bg-white border border-white/5 shadow-2xl">
                  <Image
                    src="/images/olay-modulu/gorev.png"
                    alt="Kart tabanlı olay operasyon ekranı ve görev görünümü"
                    width={853}
                    height={638}
                    className="absolute inset-0 w-full h-full object-cover object-top-left group-hover:scale-[1.01] transition-transform duration-500"
                  />
        ...
        <div className="container mx-auto px-6 lg:px-12 w-full max-w-7xl relative z-10">
          ...
          >
            ...
            >
              ...
              <div className="w-full md:w-1/2 h-45 md:h-full relative rounded-xl border border-white/10 overflow-hidden shadow-inner shrink-0 group-hover:border-cyan-500/40 transition-colors">
                <Image
                  src="/images/olay-modulu/gecmis.png"
                  alt="Olay kaydı zaman çizelgesi — iletişim ve geçmiş aktiviteler"
                  fill
            ...
            >
              ...
              <div className="relative w-full flex-1 rounded-xl border border-white/10 overflow-hidden">
                <Image
                  src="/images/olay-modulu/gorusmeler.png"
                  alt="Toplu görüşme listesi ve gelişmiş filtreleme"
                  fill
                  className="object-cover object-top-left"
                />
              </div>
            ...
            >
              ...
              <div className="relative w-full flex-1 rounded-xl border border-white/10 overflow-hidden bg-white">
                <Image
                  src="/images/olay-modulu/varlik.png"
                  alt="Hızlı aksiyon ve pinleme arayüzü"
                  fill
                  className="object-cover object-top-left"
                />
              </div>
            ...
            >
              ...
              <div className="w-full md:w-1/2 h-45 md:h-full relative rounded-xl border border-white/10 overflow-hidden shadow-inner shrink-0 group-hover:border-indigo-500/40 transition-colors">
                <Image
                  src="/images/olay-modulu/worklog.png"
                  alt="Görev bağımlılıkları ve worklog efor takibi"
                  fill
                  className="object-cover object-top-left"
                />
              </div>
            ...
            >
              ...
              <div className="relative w-full flex-1 rounded-xl border border-white/10 overflow-hidden bg-white">
                <Image
                  src="/images/olay-modulu/cozum.png"
                  alt="STE ve bilgi bankası destekli çözüm önerileri"
                  fill
                  className="object-cover object-top-left"
                />
              </div>
            ...
            >
              ...
              <div className="relative w-full flex-1 rounded-xl border border-white/10 overflow-hidden">
                <Image
                  src="/images/olay-modulu/tekrarlananolay.png"
                  alt="Tekrarlayan olay örüntüleri ve Problem bağlantısı"
                  fill
                  className="object-cover object-top-left"
                />
              </div>
            ...
            >
              ...
              <div className="relative w-full flex-1 rounded-xl border border-white/10 overflow-hidden bg-white">
                <Image
                  src="/images/olay-modulu/iliski.png"
                  alt="CMDB CI ilişkilendirme ve bağımlılık zinciri"
                  fill
                  className="object-cover object-top-left"
                />
              </div>
            ...
            >
              ...
              <div className="relative w-full flex-1 rounded-xl border border-white/10 overflow-hidden bg-white">
                <Image
                  src="/images/olay-modulu/kapatmakurallari.png"
                  alt="Kapatma kuralları, SLA ve OLA uyumu"
                  fill
                  className="object-cover object-top-left"
                />
              </div>
